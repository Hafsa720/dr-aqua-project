        ...
        {action && (
          <button
            ...
            className={cn(
              ...
              action.variant === 'secondary' && 'bg-secondary-600 text-white hover:bg-secondary-700 focus:ring-secondary-500',
              action.variant === 'outline' && 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-primary-500',
              !action.variant && 'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-500',
    ...
    >
      <div className={cn('flex flex-col items-center', sizeClasses.spacing)}>
        ...
        <div className="space-y-2">
          <h3 className={cn('text-gray-900', sizeClasses.title)}>
            {title}
          </h3>

          {description && (
            <p className={cn('text-gray-500 max-w-sm', sizeClasses.description)}>
              {description}
            </p>
          )}
        </div>
...
export const EmptySearchResults: React.FC<Omit<EmptyStateProps, 'icon' | 'title'> & { searchTerm?: string }> = ({
  searchTerm,
  description,
  ...props
}) => (
...
export const EmptyInbox: React.FC<Omit<EmptyStateProps, 'icon' | 'title'>> = ({ description, ...props }) => (
  <EmptyState
    icon={defaultIcons.inbox}
    title="Inbox is empty"
    description={description || 'When you receive messages, they will appear here.'}
    {...props}
  />
);

export const EmptyFolder: React.FC<Omit<EmptyStateProps, 'icon' | 'title'>> = ({ description, ...props }) => (
  <EmptyState
...
export const EmptyFavorites: React.FC<Omit<EmptyStateProps, 'icon' | 'title'>> = ({ description, ...props }) => (
  <EmptyState
    icon={defaultIcons.star}
    title="No favorites yet"
    description={description || 'Items you favorite will appear here for quick access.'}
    {...props}
  />
);
...
export const EmptyNotifications: React.FC<Omit<EmptyStateProps, 'icon' | 'title'>> = ({ description, ...props }) => (
  <EmptyState
...
export const EmptyCharts: React.FC<Omit<EmptyStateProps, 'icon' | 'title'>> = ({ description, ...props }) => (
  <EmptyState
...
export const EmptyUsers: React.FC<Omit<EmptyStateProps, 'icon' | 'title'>> = ({ description, ...props }) => (
  <EmptyState
...
export const useEmptyState = (data: any[], loading: boolean = false, error: Error | null = null) => {
