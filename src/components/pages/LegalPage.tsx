...
const LoadingSkeleton: React.FC = () => (
  <div
    className='min-h-screen bg-white dark:bg-slate-900 pt-96 pb-28'
      ...
      <div className='max-w-6xl mx-auto pt-8'>
        <div className='animate-pulse'>
          ...
          <div className='text-center mb-16'>
            {/* Title */}
            <div className='h-14 bg-gray-300 dark:bg-gray-700 rounded-lg mx-auto mb-6 max-w-md'></div>

            {/* Description */}
            <div className='h-6 bg-gray-200 dark:bg-gray-600 rounded mx-auto mb-6 max-w-2xl'></div>

            {/* Subtitle */}
            <div className='h-5 bg-gray-200 dark:bg-gray-600 rounded mx-auto mb-6 max-w-xl'></div>
          ...
          <div className='max-w-4xl mx-auto space-y-8'>
            ...
            <div className='bg-gray-50 dark:bg-slate-800/50 rounded-lg p-6 border border-gray-200 dark:border-gray-700'>
              <div className='h-6 bg-gray-300 dark:bg-gray-600 rounded mb-4 max-w-48'></div>
              <div className='space-y-2'>
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className='h-4 bg-gray-200 dark:bg-gray-500 rounded max-w-64'
                  ></div>
                ))}
              </div>
            </div>
            ...
            {[...Array(6)].map((_, i) => (
              <div key={i} className='space-y-4'>
                {/* Section heading */}
                <div className='h-8 bg-gray-300 dark:bg-gray-700 rounded max-w-80'></div>
                ...
                <div className='space-y-3'>
                  {[...Array(3 + (i % 3))].map((_, j) => (
                    <div key={j} className='space-y-2'>
                      ...
                      <div className='h-4 bg-gray-200 dark:bg-gray-600 rounded max-w-5/6'></div>
                      {j % 2 === 0 && (
                        <div className='h-4 bg-gray-200 dark:bg-gray-600 rounded max-w-4/5'></div>
                      )}
                    </div>
                  ))}
                </div>
          ...
          {/* Footer skeleton */}
          <div className='mt-16 p-6 bg-gray-50 dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-gray-700 max-w-4xl mx-auto'>
            <div className='flex items-start gap-4'>
              <div className='w-8 h-8 bg-gray-300 dark:bg-gray-600 rounded-full flex-shrink-0'></div>
              <div className='flex-1'>
                <div className='h-5 bg-gray-300 dark:bg-gray-600 rounded mb-2 max-w-48'></div>
                <div className='h-4 bg-gray-200 dark:bg-gray-500 rounded mb-4 max-w-80'></div>
                <div className='flex gap-4'>
                  <div className='h-4 bg-gray-200 dark:bg-gray-500 rounded w-36'></div>
                  <div className='h-4 bg-gray-200 dark:bg-gray-500 rounded w-24'></div>
                </div>
              </div>
            </div>
          </div>
...
const ErrorDisplay: React.FC<{ error: string; onRetry?: () => void }> = ({
  ...
  <div className='min-h-screen bg-white dark:bg-slate-900 pt-72 pb-28'>
    <div className='layout'>
    ...
    <div className='min-h-screen bg-white dark:bg-slate-900 pt-72 pb-28'>
      <div className='layout'>
        <div className='max-w-6xl mx-auto mt-8'>
          ...
          >
            <h1 className='text-4xl md:text-5xl font-bold text-primary-900 dark:text-gray-100 mb-6'>
              {title}
            </h1>
            ...
            {subtitle && (
              <p className='text-gray-500 dark:text-gray-400 text-base max-w-xl mx-auto mb-6'>
                {subtitle}
              </p>
            )}
          ...
          <motion.div
            ...
            className='mt-16 p-6 bg-gray-50 dark:bg-slate-800/50 rounded-lg border border-gray-200 dark:border-gray-700'
          >
            <div className='flex items-start gap-4'>
