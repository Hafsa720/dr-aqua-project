          ...
          <ol className='mt-8 space-y-6'>
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                ...
                <ButtonLink href='https://github.com/your-username/rapidbizz-agency/blob/main/src/styles/colors.css'>
            ...
            <li className='space-y-2'>
              ...
              <div className='flex flex-wrap gap-2'>
                <ButtonLink variant='primary' href='https://rapidbizz.com'>
                  Primary Variant
                </ButtonLink>
                <ButtonLink
                  variant='outline'
                  isDarkBg={mode === 'dark'}
                  href='https://rapidbizz.com'
                >
                  Outline Variant
                </ButtonLink>
                <ButtonLink
                ...
                <ButtonLink variant='dark' href='https://rapidbizz.com'>
                  Dark Variant
                </ButtonLink>
                <ButtonLink variant='light' href='https://rapidbizz.com'>
                  Light Variant
                </ButtonLink>
              </div>
            </li>
