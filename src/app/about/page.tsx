...
export default function AboutPage() {
  ...
  useEffect(() => {
    setContent(language === "ur" ? aboutContentUr : aboutContentEn);
  }, [language]);
      ...
      <div className="space-y-16">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <Image
              src="/products/ro-hundred-gallon-per-day.jpg"
              alt="Dr. Aqua facility"
              width={800}
              height={600}
              className="rounded-2xl shadow-xl object-cover w-full h-[300px] md:h-[420px] lg:h-[600px]"
            />
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg border border-primary-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-primary-900">15+ Years</div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <h2 className="text-3xl font-bold text-primary-900">{content.values.title}</h2>
            <p className="text-primary-700 max-w-2xl mx-auto">{content.values.description}</p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className="pt-6 space-y-4">
                    ...
                    <h3 className="font-semibold text-lg text-primary-900">{value.title}</h3>
                    <p className="text-sm text-primary-700">{value.description}</p>
                  </CardContent>
                </Card>
              );
            })}
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-primary-700 max-w-2xl mx-auto">{content.timeline.description}</p>
          </div>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            {content.timeline.milestones.map((milestone, index) => (
              <div key={index} className="flex gap-6">
                ...
                <div className="pb-8">
                  <div className="font-semibold text-lg mb-1 text-primary-900">{milestone.year}</div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <h2 className="text-3xl font-bold text-primary-900">{content.team.title}</h2>
            <p className="text-primary-700 max-w-2xl mx-auto">{content.team.description}</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {content.team.members.map((member, index) => (
              <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 border-primary-200 hover:border-primary-300">
                <CardContent className="pt-6">
                  ...
                  />
                  <h3 className="font-semibold text-lg text-primary-900">{member.name}</h3>
        ...
        <Card className="bg-primary-500 text-white">
          <CardContent className="p-8 lg:p-12 text-center">
            <h2 className="text-2xl lg:text-3xl font-bold mb-4">{content.cta.title}</h2>
            <p className="text-primary-100 mb-6 max-w-2xl mx-auto">{content.cta.description}</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild size="lg" variant="outline" className="border text-blue-700 hover:bg-white hover:text-primary-500 cursor-pointer">
